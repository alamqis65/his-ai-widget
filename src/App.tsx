...
function getSDKConfig(): SDKConfig {
  return (window as unknown as { his_ai_widget?: { _getConfig: () => SDKConfig } })
...
const ALL_NAV: NavItem[] = [
  {
    id: 'chat', label: 'Chat MAIA', featureKey: 'chat',
  ...
  {
    id: 'speech-to-soap', label: 'SOAP', featureKey: 'soap',
  ...
  {
    id: 'clinical-pathway', label: 'Pathway', featureKey: 'pathway',
  ...
  {
    id: 'eclaim', label: 'E-Claim', featureKey: 'eclaim',
...
export function App() {
  ...
  const features = useMemo(() => resolveFeatures(cfg.features), [])
  ...
  const handleClose = () => {
    (window as unknown as { his_ai_widget?: { close: () => void } })
      .his_ai_widget?.close()
  }
    ...
    <div class="widget-root">
      ...
      <main class="widget-content">
        {active === 'chat' && features.chat && (
          <ChatFeature callbacks={{ onResultChat: cfg.onResultChat }} />
        )}
        ...
        {active === 'eclaim' && features.eclaim && (
          <EClaimFeature callbacks={{ onResultEClaim: cfg.onResultEClaim }} />
        )}
      </main>
