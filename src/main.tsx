...
window.his_ai_widget.init({
  ...
  api: {
    ...
    chatEndpoint: 'http://localhost:8000/api/v1/ai-assistant/patient-ai-assistant',
    pretext:
    ...
    pathwayEndpoint: 'http://localhost:8000/api/v1/clinical-pathway/generate',
    pathwayMasterDiagnosesEndpoint: 'http://localhost:8000/api/v1/clinical-pathway/master-diagnoses',
    eclaimEndpoint: 'http://localhost:8000/api/v1/bpjs/validate',
    //   headers: {
