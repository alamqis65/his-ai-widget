...
const MOCK_DATA: SpeechToSOAPResult[] = [
  {
    soapResult: {
      ...
      soap: {
        ...
        Interventions: 'Pasien diberikan aspirin dan clopidogrel, serta ISDN sublingual. Rujukan ke kardiologi dilakukan untuk tindakan lebih lanjut.',
      },
      generatedAt: new Date(),
      transcriptUsed: 'Pasien datang dengan keluhan nyeri dada sejak 2 hari yang lalu. Nyeri dirasakan seperti tertindih dan menjalar ke lengan kiri. Pasien juga mengeluhkan sesak napas ringan dan berkeringat dingin.',
      sugest_diagnosis: [
  ...
  },
  {
    soapResult: {
      ...
      generatedAt: new Date(),
      transcriptUsed: 'Anak laki-laki usia 7 tahun dibawa orang tua dengan demam tinggi selama 3 hari. Suhu tubuh 38.9 derajat Celsius. Pasien juga mengalami batuk dan pilek.',
      sugest_diagnosis: [
  ...
  },
  {
    soapResult: {
      ...
      generatedAt: new Date(),
      transcriptUsed: 'Pasien wanita 45 tahun dengan riwayat diabetes melitus tipe 2 datang untuk kontrol rutin. Gula darah puasa terakhir 210 mg/dL.',
      sugest_diagnosis: [
